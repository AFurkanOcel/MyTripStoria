<template>
  <div>
    ...
    <section v-if="loadingPage" class="panel">
      <p class="subtitle">Loading trip editor...</p>
    </section>

    <section v-else-if="loadError" class="panel">
      <p class="error">{{ loadError }}</p>
      <NuxtLink class="btn btn-ghost" to="/trips">Trip records</NuxtLink>
    </section>
...
onMounted(async () => {
  try {
    ...
    loadError.value = getErrorMessage(loadException, 'Trip could not be loaded.')
  } finally {
